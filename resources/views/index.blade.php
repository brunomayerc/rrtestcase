...
<div class="row">
    <div class="col-md-12">
        ...
        <ul>
            <li>
                <b>1. </b>Use the <a href="#" data-toggle="modal" data-target="#sync-tool-modal">Import Data Tool</a>(It can take a while, so please be patient.) to connect to the <b>openpaymentsdata</b> and import Doctor/Hospital names and unique identifiers.
                <br/>
